-- Add vibe_tags (AI-generated semantic labels) to events
-- Lumio Phase 2a: pre-computed Vibe Tags, no chat gateway required

ALTER TABLE events ADD COLUMN IF NOT EXISTS vibe_tags text[];

-- Recreate view to expose vibe_tags
